...
if __name__ == "__main__":
    # get dict of tokens
    token_dict = get_tokens("references/python-3.0-library", max_lines=100)
    ...
    n_random_errors = create_test_set_randomly(add_n_errors, file_count, token_dict, 80)
    ...
    save_error_file(directory + f"/{ver}/std_lib_{num_errors}-80", n_random_errors)
    ...
    n_errors_loaded = load_error_file(directory + f"/{ver}/std_lib_{num_errors}-80.pkl")
